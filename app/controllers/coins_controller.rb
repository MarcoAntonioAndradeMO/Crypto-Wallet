class CoinsController < ApplicationController
  ...
  before_action :set_mining_type_options, only: [:new, :crate, :edit, :update]
  ...
  def create
    ...
    respond_to do |format|
      if @coin.save
        ...
        format.json { render :show1, status: :created, location: @coin }
      else
  ...
  def update
    respond_to do |format|
      if @coin.update(coin_params)
        ...
        format.json { render :show1, status: :ok, location: @coin }
      else
